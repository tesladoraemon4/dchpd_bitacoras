	...
	def consultarSubRedes(self):
		...
		for line in confArch:
			...
			if(rs != None):
				...
				mask = resl.group(0)
				ipRed = self.getIdRed(ipRed,mask)
				redes.append({"ip":ipRed,"mask":mask})
		return redes


	def consultarUsuariosSegmento(self,red):
...
if __name__ == '__main__':
	...
	print(connector.consultarSubRedes())
	print(connector.consultarUsuariosSegmento(connector.consultarSubRedes()[0]))
